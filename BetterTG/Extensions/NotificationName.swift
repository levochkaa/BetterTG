...
extension Foundation.Notification.Name {
    ...
    static let contactCloseBirthdays = Self("contactCloseBirthdays")
    static let businessConnection = Self("businessConnection")
    static let newBusinessMessage = Self("newBusinessMessage")
    static let businessMessageEdited = Self("businessMessageEdited")
    static let businessMessagesDeleted = Self("businessMessagesDeleted")
